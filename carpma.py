...
def carpma():
  carpma_log = """
    ...
    2. seviye = num0 * num2 * num3 = ?
    3. seviye = num10 * num11 * num12 = ?
    4. seviye = -num0 * num1 + num2 = ?
    5. seviye = (num0 + num1) * (num2 - num3) = ?
    6. seviye = num0 - (num1 + num2 * num3) = ?
    out = çıkış
  """
  print(carpma_log)

  key_while_carpma = 0
  while key_while_carpma == 0:
    level_carpma_select = input("seviye seçiniz: ")

    if level_carpma_select == "0":
      ...
      while level_loop < level_loop_count:
        ...
        start_time = time.time() # süreyi başlat
        user_answer = int(input(f"{num10} * {num11} = "))
        end_time = time.time() # süreyi durdur
        pc_answer = num10 * num11
      ...
      while level_loop < level_loop_count:
        ...
        start_time = time.time() # süreyi başlat
        user_answer = int(input(f"{num0} * {num2} * {num3} = "))
        end_time = time.time() # süreyi durdur
        pc_answer = num0 * num2 * num3
      ...
      while level_loop < level_loop_count:
        ...
        start_time = time.time() # süreyi başlat
        user_answer = int(input(f"{num10} * {num11} * {num12} = "))
        end_time = time.time() # süreyi durdur
        pc_answer = num10 * num11 * num12
